...
package com.th.onager.stress;


import com.th.onager.Launcher;
...
/**
 * Run rotation stress test using Onager for 50 iterations.
 */
public class LauncherRotationStressTest extends ActivityInstrumentationTestCase2<Launcher> {
    ...
    private static final String LOG_TAG = "OnagerRotationStressTest";
